        ...
        <section className='section' id="contact">
            <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
                <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
                    ...
                    <p className="text-zinc-400 mt-3 mb-8 max-w-[50] max-lg:max-w-[30ch] reveal-up">
                        Reach out today to discuss your project needs and start something amazing!
                    </p>

                    <div className="flex  items-center gap-2 mt-auto">
                        {socialLinks.map(({ href, icon }, key) => (
                            <a href={href} key={key} target='_blank' className="w-12 h-12 grid place-items-center ring-inset ring-2 ring-zinc-50/5 
                            rounded-lg transition-[background-color, color] hover:bg-zinc-50 hover:text-zinc-950 active:bg-zinc-50/80 reveal-up">
                                {icon}
                            </a>
                        ))}
                    </div>
                ...
                <form action="https://getform.io/f/apjnrkpa" method='POST' className="xl:pl-10 2xl:pl-20">
                    <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
                        <div className="mb-4">
                            <label htmlFor="name" className="label reveal-up">Name</label>
                            <input type="text" className='text-field reveal-up' id="name" name='name' autoComplete='name' required placeholder='Boopathy' />
                        </div>

                        <div className=" mb-4">
                            <label htmlFor="email" className="label reveal-up">E-Mail</label>
                            <input type="email" className='text-field reveal-up' id="emial" name='email' autoComplete='email' required placeholder='Boopathy@example.com' />
                        </div>
                    </div>

                    <div className="mb-4">
                        <label htmlFor="message" className="label reveal-up">Message</label>
                        <textarea className='text-field resize-y min-h-32 max-h-80 reveal-up' name="message" id="message" placeholder='Hi!' required></textarea>
                    </div>
